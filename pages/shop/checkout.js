 ...
 * Customer never sees PayPal — pays with any card/Apple Pay on HUSIN page
 * PayPal JS SDK processes payment silently in background
...
export default function CheckoutPage() {
  ...
  // Get productId and quantity from URL
  ...
  // Load PayPal SDK when moving to payment step
  useEffect(() => {
  ...
  async function initPayPal() {
    try {
      ...
      paypalOrderId.current = data.orderId
      setPaypalReady(true)
      ...
      // ── Card Fields (Visa / Mastercard / Mada directly on page) ──
              ...
              <div style={S.card}>
                ...
                {paypalReady && (
                  <>
                    ...
                    {/* PayPal / Apple Pay / Google Pay buttons */}
